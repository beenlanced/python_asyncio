...
async def main():
    ...
    # Run in Process Pool
    loop = asyncio.get_running_loop() #have to get the running loop to use loop.run_in_executor method below
...
if __name__ == "__main__":
    ...
    results = asyncio.run(main()) #remember this starts the even loop
    print(results)
